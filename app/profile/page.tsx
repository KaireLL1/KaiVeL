              ...
              {historyByManga.map((h: any) => (
                <Link key={h.manga_id} href={`/manga/${h.manga_id}`} className="manga-card">
                  <div className="manga-card-cover">
                    ...
                    <div style={{ position: 'absolute', bottom: 8, left: 6, right: 6, fontSize: 10, fontWeight: 600, color: '#fff', background: 'rgba(0,0,0,0.7)', borderRadius: 4, padding: '2px 6px', textAlign: 'center', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {h.chapter_name || 'Chapter ?'}
                    </div>
                  </div>
                  <div className="manga-card-info">
                    <div className="manga-card-title">{h.manga_title || h.manga_id}</div>
